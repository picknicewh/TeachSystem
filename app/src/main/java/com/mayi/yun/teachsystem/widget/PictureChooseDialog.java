...
import com.mayi.yun.teachsystem.utils.CommonUtil;
...
import com.mayi.yun.teachsystem.utils.PermissionsChecker;
...
public class PictureChooseDialog extends AlertDialog implements View.OnClickListener {
    ...
    private void initView() {
        ...
        tv_cance1 = findViewById(R.id.tv_cance1);
    ...
    public void onClick(View v) {
        ...
        switch (viewId) {
            case R.id.tv_album:
                ...
                context.startActivityForResult(intent, Constant.RESULT_IMAG);
                break;
            case R.id.tv_take_picture:
                ...
                if (CommonUtil.isCameraCanUse()) {
                    if (Build.VERSION.SDK_INT >= 24) {
                        ...
                        Uri contentUri = FileProvider.getUriForFile(context, "com.mayi.yun.teachsystem.provider", outputFile);
                        camera.putExtra(MediaStore.EXTRA_OUTPUT, contentUri);
                    }
                    context.startActivityForResult(camera, Constant.RESULT_CAMERA);
                 //   update(imagePath);
                }
                break;
            case R.id.tv_cance1:
